    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center">
                <Link to="/cases" className="mr-4 text-gray-500 hover:text-primary-700 transition-colors">
                    <ArrowLeft className="w-6 h-6" />
                </Link>
                <h1 className="text-3xl font-bold text-primary-900 font-serif">{caseItem.title}</h1>
            </div>

            <div className="bg-white shadow-lg overflow-hidden sm:rounded-lg border border-gray-200">
                <div className="px-4 py-5 sm:px-6 bg-gray-50 border-b border-gray-200">
                    <h3 className="text-lg leading-6 font-medium text-primary-900 font-serif">Case Information</h3>
